...
import com.lyk.dragGridView.DragGridViewDel;
...
public class DemoMainActivity extends Activity implements OnItemClickListener{
	 ...
	 * 一页可见提条目数
	 */
	private static final int VISIBIY_NUMS = 48;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		DragGridViewDel mDragGridViewDel = (DragGridViewDel)findViewById(R.id.dragGridViewDel);
		mDragGridViewDel.setOnItemClickListener(this);
		...
		mDragGridViewDel.setAdapter(mDragAdapter);
		//设置需要抖动
		mDragGridViewDel.setNeedShake(true);
	}
	@Override
